...
object RoomRepository : DropRepository {
    ...
    override fun addDrop(drop: Drop) {
        InserAsyncTask(dropDao).execute(drop)
    }
    ...
    private class InserAsyncTask internal constructor(private val dao:DropDao):AsyncTask<Drop, Void, Void>(){
